...
<body>
    ...
    <section class="section" id="our_product_section">
      ...
      if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo '    <figure>';
          echo '        <img src="' . $url . '/assets/products/' . $productImage . '" alt="' . $productName . '" loading="lazy" />';
          echo '    </figure>';
    ...
    <section class="video_section section">
        ...
        <div class="video_main_container flex">
            ...
            <div class="video_right_container">
                <a href="/aboutus/" class="video_play_btn">
                    About Us
                </a>
            </div>
        </div>
        ...
        <div class="why_choose_us_main_container flex">
            <div class="why_choose_us_left_container">
                <figure class="why_choose_us_img_container">
                    <img src="../assets/home/farmer.webp" alt="why-us" loading="lazy" />
                </figure>
    ...
    <section class="section">
        ...
        <div class="our_pride_card_container flex">
            <figure class="our_pride_card">
                <img src="/assets/cert/apeda.png" loading="lazy" alt="apeda" />
            </figure>
            <figure class="our_pride_card">
                <img src="/assets/cert/dgft.png" loading="lazy" alt="dgft" />
            </figure>
            <figure class="our_pride_card">
                <img src="/assets/cert/fssai.png" loading="lazy" alt="fssai" />
            </figure>
            <figure class="our_pride_card">
                <img src="/assets/cert/iso.png" loading="lazy" alt="iso" />
            </figure>
            <figure class="our_pride_card">
                <img src="/assets/cert/sgs.png" loading="lazy" alt="sgs" />
            </figure>
            <figure class="our_pride_card">
                <img src="/assets/cert/spicesBoard.png" loading="lazy" alt="spicesBoard" />
            </figure>
        </div>
    </section>
    <footer class="footer flex">
        ...
        <div class="footer_container">
            ...
            <ul class="footer_list_container">
                <li>
                    <a href="tel: +917201065314" target="_blank" class="flex"><i class="fa-solid fa-phone"></i>+91 72
                        0106 5314</a>
                </li>
                <li>
                    <a href="mailto: info@apexriminternational.com" target="_blank" class="flex"><i
                            class="fa-solid fa-envelope"></i>info@apexriminternational.com</a>
                </li>
                <li>
                    <a href="#" class="flex"><i class="fa-solid fa-location-dot"></i>Survey Number: 28,
                        Goda-Ogadnath Temple Road <br />
                        Ogadpura, Diyodar, State: Gujarat, <br />
                        pincode: 385320</a>
                </li>
            </ul>
        </div>
